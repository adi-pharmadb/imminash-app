...
- [x] 1.0 Complete project initialization and configuration
  - [x] 1.1 Initialize Next.js 15 with App Router, React 19, TypeScript strict mode
  ...
  - [x] 1.3 Install and configure Supabase client
  ...
  - [x] 1.4 Install and configure Anthropic SDK
  ...
  - [x] 1.7 Create `.env.example` with all required environment variables
    - `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`
    - `ANTHROPIC_API_KEY`, `AI_MODEL`
    - `ADMIN_SECRET` (for admin data upload endpoint)
  - [x] 1.8 Configure Vercel deployment
...
- [x] 2.0 Complete database schema and seed data
  - [x] 2.1 Write 6 focused tests for database schema and seed data
  ...
  - [x] 2.2 Create `leads` table migration
    ...
    - Add index on `email`
  - [x] 2.3 Create `profiles` table migration
    ...
    - Add index on `email`
  - [x] 2.4 Create `occupations` table migration
  ...
  - [x] 2.5 Create `state_nominations` table migration
  ...
  - [x] 2.6 Create `invitation_rounds` table migration
    ...
    - Add index on `anzsco_code`
  - [x] 2.7 Create `assessments` table migration
  ...
  - [x] 2.8 Create `assessing_body_requirements` table migration
  ...
  - [x] 2.9 Create `documents` table migration
    ...
    - Add index on `user_id`
  - [x] 2.10 Create `conversations` table migration
  ...
  - [x] 2.11 Create seed script for occupations table from `occupations.csv`
  ...
  - [x] 2.12 Create seed script for state_nominations from state CSV files
  ...
  - [x] 2.13 Create seed script for invitation_rounds from `rounds.csv`
    - Parse CSV and insert into invitation_rounds table
    - Verify all rows loaded [AC-DB3]
  - [x] 2.14 Populate assessing_body_requirements for the Big 4
  ...
  - [x] 2.15 Ensure database layer tests pass
...
- [x] 3.0 Complete points calculator with full test coverage
  - [x] 3.1 Write 8 focused tests for the points calculator
  ...
  - [x] 3.2 Create `types/assessment.ts` with shared TypeScript interfaces
  ...
  - [x] 3.3 Port `estimatePoints()` to `lib/points-calculator.ts`
  ...
  - [x] 3.4 Port `calcPointsSoFar()` lightweight variant for live stepper counter
  ...
  - [x] 3.5 Port `parseExperienceYears()` helper for employer sponsored eligibility checks
  ...
  - [x] 3.6 Derive `partnerStatus` from relationshipStatus + partnerSkills combination
  ...
  - [x] 3.7 Ensure points calculator tests pass
...
- [x] 4.0 Complete state nomination eligibility and pathway logic
  - [x] 4.1 Write 8 focused tests for state nominations, possibility rating, and employer eligibility
  ...
  - [x] 4.2 Port `getStateEligibility()` to `lib/state-nominations.ts`
  ...
  - [x] 4.3 Create possibility rating logic in `lib/pathway-signals.ts`
  ...
  - [x] 4.4 Port `getPathwaySignal()` for rule-based visa pathway statements
  ...
  - [x] 4.5 Port `getPrimaryList()` for determining MLTSSL/CSOL/STSOL/ROL from occupation booleans
  - [x] 4.6 Create employer sponsored eligibility logic in `lib/employer-eligibility.ts`
  ...
  - [x] 4.7 Ensure state nomination and pathway tests pass
...
- [x] 5.0 Complete AI occupation matching with keyword fallback
  - [x] 5.1 Write 5 focused tests for AI occupation matching
  ...
  - [x] 5.2 Create `POST /api/match-occupations` API route
  ...
  - [x] 5.3 Implement AI matching via Anthropic SDK with tool use
  ...
  - [x] 5.4 Implement canonical validation of AI-returned titles
  ...
  - [x] 5.5 Port keyword fallback matching from legacy `matchOccupations()`
  ...
  - [x] 5.6 Ensure AI matching tests pass
...
- [x] 6.0 Complete landing page and 7-page stepper flow
  - [x] 6.1 Write 7 focused tests for stepper flow behavior
  ...
  - [x] 6.2 Build Landing/Hero page at `app/page.tsx`
  ...
  - [x] 6.3 Create stepper flow page at `app/assessment/page.tsx`
  ...
  - [x] 6.6 Build Page 3 (Additional Qualifications, skippable)
  ...
  - [x] 6.7 Build Page 4 (Work Experience)
  ...
  - [x] 6.8 Build Page 5 (Role Details, conditional)
  ...
  - [x] 6.9 Build Page 6 (English & Languages)
  ...
  - [x] 6.10 Build Page 7 (Final Details)
  ...
  - [x] 6.11 Implement live points counter in header
  ...
  - [x] 6.12 Implement pill-style select component
  ...
  - [x] 6.13 Implement field validation and Continue button logic
  ...
  - [x] 6.14 Ensure stepper flow tests pass
...
- [x] 7.0 Complete analyzing screen and teaser screen
  - [x] 7.1 Write 5 focused tests for analyzing and teaser screens
  ...
  - [x] 7.2 Build Analyzing Screen at `components/stepper/AnalyzingScreen.tsx`
  ...
  - [x] 7.3 Build Teaser Screen at `components/stepper/TeaserScreen.tsx`
  ...
  - [x] 7.4 Wire stepper completion to analyzing screen
  ...
  - [x] 7.5 Ensure analyzing and teaser tests pass
...
- [x] 8.0 Complete email gate, assessment persistence, and full results dashboard
  - [x] 8.1 Write 8 focused tests for email gate, assessment API, and results dashboard
  ...
  - [x] 8.2 Build Email Gate at `components/stepper/EmailGate.tsx`
  ...
  - [x] 8.3 Create `POST /api/leads` API route
  ...
  - [x] 8.4 Create `POST /api/assessments` API route
  ...
  - [x] 8.5 Wire email gate submission flow
  ...
  - [x] 8.6 Build Full Results Dashboard at `app/results/page.tsx`
  ...
  - [x] 8.7 Build Tab 1: Skills Assessment
  ...
  - [x] 8.8 Build Tab 2: Employer Sponsored
  ...
  - [x] 8.9 Add sticky CTA at bottom of results dashboard
    - "Start Document Preparation" button linking to Phase 2 auth flow
    - Fixed/sticky positioning at bottom of viewport
  - [x] 8.10 Port `assessingAuthorityInfo` map for cost/timeline display
    - Used on occupation cards to show assessing body details
  - [x] 8.11 Ensure email gate, assessment, and results tests pass
...
- [x] 9.0 Complete magic link authentication flow
  - [x] 9.1 Write 4 focused tests for auth flow
  ...
  - [x] 9.2 Configure Supabase Auth for magic link
  ...
  - [x] 9.3 Build auth modal component at `components/auth/AuthModal.tsx`
  ...
  - [x] 9.4 Implement post-auth assessment linking
  ...
  - [x] 9.5 Implement profile creation on first auth
  ...
  - [x] 9.6 Implement return user detection
...
- [x] 10.0 Complete document workspace split-panel UI
  - [x] 10.1 Write 6 focused tests for workspace UI
  ...
  - [x] 10.2 Build workspace layout at `app/workspace/page.tsx`
  ...
  - [x] 10.3 Build chat panel component at `components/workspace/ChatPanel.tsx`
  ...
  - [x] 10.4 Build document preview panel at `components/workspace/DocumentPanel.tsx`
  ...
  - [x] 10.5 Implement context pre-filling from Phase 1
  ...
  - [x] 10.6 Implement document change highlighting
  ...
  - [x] 10.7 Implement conversation persistence
  ...
  - [x] 10.8 Implement mobile toggle behavior
  ...
  - [x] 10.9 Ensure workspace UI tests pass
...
- [x] 11.0 Complete AI chat streaming API and duty alignment
  - [x] 11.1 Write 5 focused tests for chat API and duty alignment
  ...
  - [x] 11.2 Create `POST /api/chat` streaming endpoint
  ...
  - [x] 11.3 Build system prompt construction in `lib/chat-prompt.ts`
  ...
  - [x] 11.4 Implement document update markers in AI responses
  ...
  - [x] 11.5 Implement duty alignment engine in `lib/duty-alignment.ts`
  ...
  - [x] 11.6 Save document updates to database
  ...
  - [x] 11.7 Ensure chat API and duty alignment tests pass
...
- [x] 12.0 Complete document generation and download system
  - [x] 12.1 Write 4 focused tests for document download
  ...
  - [x] 12.2 Create `GET /api/documents/[assessmentId]` API route
  ...
  - [x] 12.3 Create `POST /api/documents/[documentId]/download` API route
  ...
  - [x] 12.4 Implement PDF generation
  ...
  - [x] 12.5 Implement DOCX generation
  ...
  - [x] 12.6 Create `POST /api/documents/[assessmentId]/download-all` API route
  ...
  - [x] 12.7 Build download UI in workspace
  ...
  - [x] 12.8 Ensure document download tests pass
...
- [x] 13.0 Complete admin data upload endpoint
  - [x] 13.1 Write 3 focused tests for admin upload
  ...
  - [x] 13.2 Create `POST /api/admin/upload-data` API route
  ...
  - [x] 13.3 Implement CSV parsing and upsert logic
    - Parse CSV with papaparse
  ...
  - [x] 13.4 Ensure admin upload tests pass
...
- [x] 14.0 Review existing tests and verify end-to-end flows
  - [x] 14.1 Review all tests from Task Groups 1-13
  ...
  - [x] 14.2 Write up to 10 additional integration tests to fill critical gaps
  ...
  - [x] 14.3 Run all feature-specific tests
  ...
  - [x] 14.4 Verify Phase 1 end-to-end flow manually
  ...
  - [x] 14.5 Verify Phase 2 end-to-end flow manually
  ...
  - [x] 14.6 Verify edge cases manually
